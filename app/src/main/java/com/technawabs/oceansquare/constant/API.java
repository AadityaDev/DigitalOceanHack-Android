...
public class API {
    ...
    public static final String BASE_URL = "http://oceansquare.tk:8083/";
    ...
    public static final String SEARCH_QUERY = HOME + "?searchQuery=";
    public static final String POST_QUERY = BASE_URL + "createDropletData=";
}
